---
layout: post
title: LibGDX--The sources of Actor
---
```
/*******************************************************************************
...
/**
 * 2D scene graph node. An actor has a position, rectangular size, origin, scale, rotation,
 * Z index, and color. The position
 * corresponds to the unrotated, unscaled bottom left corner of the actor. The position is
 * relative to the actor's parent. The
